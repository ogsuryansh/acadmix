  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Success State - Show when payment is approved */}
        {currentPayment?.status === 'approved' ? (
          <div className="max-w-2xl mx-auto">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-6">
                Your payment has been approved and you now have access to <span className="font-semibold text-gray-900 dark:text-white">{book.title}</span>
              </p>

              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 mb-6">
                <p className="text-sm text-green-800 dark:text-green-200">
                  <strong>UTR:</strong> {currentPayment.utr}
                </p>
                <p className="text-sm text-green-800 dark:text-green-200 mt-1">
                  <strong>Amount Paid:</strong> ₹{currentPayment.amount}
                </p>
                {currentPayment.approvedAt && (
                  <p className="text-sm text-green-800 dark:text-green-200 mt-1">
                    <strong>Approved:</strong> {new Date(currentPayment.approvedAt).toLocaleString()}
                  </p>
                )}
              </div>
          ...
          /* Payment Form - Show when payment is not approved */
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-gray-900 dark:text-white text-lg truncate">{book.title}</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 line-clamp-2">{book.description}</p>
        ...
        {/* Instructions - Only show when payment is not approved */}
        {currentPayment?.status !== 'approved' && (
