          ...
          {isLoading ? (
            ...
            <div className="space-y-16">
              ...
              <section className="animate-fade-in">
                <div className="text-center py-20 card border-dashed border-2 border-primary-300 dark:border-primary-600">
                  <BookOpen className="h-20 w-20 text-primary-500 dark:text-primary-400 mx-auto mb-6" />
                  <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Class 12 Materials Not Available Yet</h2>
                  <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-2">
                    We're currently working on adding comprehensive study materials for Class 12.
                  </p>
                  <p className="text-gray-500 dark:text-gray-500">
                    In the meantime, check out our Class 11 materials to build a strong foundation!
                  </p>
                </div>
              </section>
